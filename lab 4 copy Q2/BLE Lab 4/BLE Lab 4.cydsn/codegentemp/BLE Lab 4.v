...
module BLE_v1_20_0 (
	...
	cy_clock_v1_0
		#(.id("6fb550e4-b18b-45f8-bc89-423769260728/5ae6fa4d-f41a-4a35-8821-7ce70389cb0c"),
...
// IDAC_P4_v1_0(IDACRange=0, IDACValue=16, Polarity=1, Resolution=8, CY_COMPONENT_NAME=IDAC_P4_v1_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=CapSense:IDAC1, CY_INSTANCE_SHORT_NAME=IDAC1, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=true, CY_VERSION=PSoC Creator  3.1 SP2, INSTANCE_NAME=CapSense_IDAC1, )
...
module CapSense_CSD_P4_v2_10_3 ;
	...
	cy_clock_v1_0
		#(.id("de9e1a0a-b090-4d9a-a7d5-d434c5c308db/74063576-f256-4f8f-8a82-9abdee876261"),
	...
	cy_psoc3_pins_v1_10
		#(.id("de9e1a0a-b090-4d9a-a7d5-d434c5c308db/899719c0-e797-4403-a44f-07a66de2cbeb"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("de9e1a0a-b090-4d9a-a7d5-d434c5c308db/73b612cd-240c-4d8e-8340-ea28aabf4b11"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("de9e1a0a-b090-4d9a-a7d5-d434c5c308db/9a635726-510c-483c-9c5c-3e233ee2906a"),
		  .source_clock_id("413DE2EF-D9F2-4233-A808-DFAF137FD877"),
		  .divisor(255),
		  .period("0"),
		  .is_direct(0),
